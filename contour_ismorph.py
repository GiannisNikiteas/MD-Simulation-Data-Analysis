...
for i in range(len(rho_ref)):
    isomorph_line = Isomorph(1, rho_ref[i], 0.5, t_iso_line)
    temp_rho, temp_a = isomorph_line.gen_line(8)
...
# ax.plot_surface(rho_iso, t_iso, a_iso, alpha=0.9)#, cmap=cm.jet)
